...
<head>
    ...
    <title>Bugtracker: My profile</title>
...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-10" style="background-color: #8F8F8F">
            ...
            <form role="form" action="/profileSimpleSettings?id=${user.getId()}" method="post">
                <div class="form-group">
                    ...
                    <input type="text" id="lastName" name="lastName" class="form-control"
                           <#if user.getLastName()??>value="${user.getLastName()}"
                               <#else>value=""
                           </#if> >
                    <label for="phoneNumber">Phone number</label>
                    <input type="text" id="phoneNumber" name="phoneNumber" class="form-control"
                           <#if user.getPhoneNumber()??>value="${user.getPhoneNumber()}"
                           <#else>value=""
                           </#if> >
                </div>
